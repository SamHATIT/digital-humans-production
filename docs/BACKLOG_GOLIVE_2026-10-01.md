...
| GL-23 | **Bloquant** | Écart de prix Pro : Stripe facture **49 €/mois** (`price_1TRW5X2U0jLqzz5TWvNKYxow`, sandbox) alors que le site annonce **79 € HT/mois**. Mesuré le 17/09 pendant la souscription de bout en bout — la page de paiement affiche « Subscribe to Pro €49.00 per month ». | Sam tranche le prix, puis : créer le prix en production Stripe au bon montant, mettre `STRIPE_PRICE_ID_PRO` à jour, revérifier que la page de paiement affiche le même montant que le site. Idem pour Team (1 490 € à vérifier). | 👤 puis ❌ |
