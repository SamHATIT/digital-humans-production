...
| GL-13 | Haute | Aucun canal de support client défini pour l'ouverture (DEC-0802-04 : Email-to-Case Salesforce, jamais mis en place). | Sam choisit : Email-to-Case (Service Cloud) ou boîte support@ + procédure de réponse sous 48 h affichée dans les CGV. | 👤 |
...
| GL-16 | Haute | Rétention des conversations Sophie : 90 jours tranchés (DEC-0813-02 / 0817-04) ; le code (`chat_log.py`) ne purge pas, la politique de confidentialité doit dire la même chose (lié RGPD-04 : la promesse « zero data retention » du Free est fausse). | Cron de purge à 90 j + test ; politique de confidentialité et CGV alignées ; retirer la promesse ZDR ou la rendre vraie. | ❌ |
