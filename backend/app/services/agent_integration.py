...
class AgentIntegrationService:
    ...
    async def execute_agent(
        ...
        try:
            ...
            # execution_id is now passed as parameter

            # Define output file
            output_filename = f"{project_id}_{str(execution_id)}_{agent_id}.json"
            ...
            try:
                ...
                try:
                    ...
                    # Save to database
                    deliverable_id = self._save_agent_deliverable(
                        agent_output=agent_output_data,
                        execution_id=execution_id,
                        agent_id=agent_id
                    )
                except Exception as e:
                    logger.warning(f"Could not parse/save agent output: {str(e)}")
