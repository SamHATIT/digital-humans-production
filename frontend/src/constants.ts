...
export const AGENTS: Agent[] = [
  ...
  { id: 'research_analyst', name: 'Emma', role: 'Research Analyst', description: 'Analyzes use cases, validates coverage, and writes the final SDS document.', avatar: '/avatars/emma-research.png', isMandatory: true },
...
export const MANDATORY_AGENTS = ['pm', 'ba', 'research_analyst', 'architect'];
